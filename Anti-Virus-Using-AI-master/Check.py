...
if __name__ == '__main__':
    ...
    # Load classifier
    classifier_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'classifier/classifier.pkl')
    clf = joblib.load(classifier_path)

    features_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'classifier/features.pkl')
    ...
    print(f'The file {os.path.basename(args.FILE)} is {"malicious" if res else "legitimate"}')
